...
import Entidades.ProductSobrecarga;
...
public class Sobrecarga {
	...
	public static void main(String[] args) {
		...
		ProductSobrecarga product = new ProductSobrecarga(name, price); //Instancia com parametros obrigando a iniciar já com dados do produto
